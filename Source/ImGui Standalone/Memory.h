...
// Memory namespace to call modules
namespace _memory {
	const auto mem = Memory("yourgamegoeshere.exe"); // Replace with your game.
	//const auto client = mem.GetModuleAddress("client.dll"); //CSGO Example for dll files
